...
/// A pointer to the CAR register block that can be accessed by dereferencing it.
pub const REGISTERS: *const Registers = CAR as *const Registers;
...
register_structs! {
    ...
    pub Registers {
        ...
        (0x01C => _reserved0: [ReadWrite<u8>; 0x8]),
        ...
        (0x094 => _reserved6: [ReadWrite<u8>; 0x4]),
        ...
        (0x0D4 => _reserved7: [ReadWrite<u8>; 0x4]),
        ...
        (0x158 => _reserved13: [ReadWrite<u8>; 0xC]),
        (0x164 => pub CLK_RST_CONTROLLER_CLK_SOURCE_SDMMC4_0: ReadWrite<u32>),
        (0x168 => _reserved14: [ReadWrite<u8>; 0x10]),
        ...
        (0x184 => _reserved15: [ReadWrite<u8>; 0x14]),
        ...
        (0x1A4 => _reserved16: [ReadWrite<u8>; 0x4]),
        (0x1A8 => pub CLK_RST_CONTROLLER_CLK_SOURCE_VI_SENSOR_0: ReadWrite<u32>),
        (0x1AC => _reserved17: [ReadWrite<u8>; 0x8]),
        ...
        (0x1C4 => _reserved18: [ReadWrite<u8>; 0x8]),
        (0x1CC => pub CLK_RST_CONTROLLER_CLK_SOURCE_OWR_0: ReadWrite<u32>),
        (0x1D0 => _reserved19: [ReadWrite<u8>; 0x4]),
        ...
        (0x1E0 => _reserved20: [ReadWrite<u8>; 0x14]),
        ...
        (0x200 => _reserved21: [ReadWrite<u8>; 0x80]),
        ...
        (0x2B0 => _reserved22: [ReadWrite<u8>; 0x44]),
        (0x2F4 => pub CLK_RST_CONTROLLER_DFLL_BASE_0: ReadWrite<u32>),
        (0x2F8 => _reserved23: [ReadWrite<u8>; 0x8]),
        ...
        (0x318 => _reserved24: [ReadWrite<u8>; 0x8]),
        ...
        (0x338 => _reserved25: [ReadWrite<u8>; 0x4]),
        ...
        (0x344 => _reserved26: [ReadWrite<u8>; 0x14]),
        ...
        (0x37C => _reserved27: [ReadWrite<u8>; 0x4]),
        ...
        (0x38C => _reserved28: [ReadWrite<u8>; 0x14]),
        ...
        (0x3A8 => _reserved29: [ReadWrite<u8>; 0xC]),
        ...
        (0x3C8 => _reserved30: [ReadWrite<u8>; 0x8]),
        (0x3D0 => pub CLK_RST_CONTROLLER_CLK_SOURCE_AHUB_0: ReadWrite<u32>),
        (0x3D4 => _reserved31: [ReadWrite<u8>; 0x10]),
        ...
        (0x3F8 => _reserved32: [ReadWrite<u8>; 0x4]),
        ...
        (0x42C => _reserved35: [ReadWrite<u8>; 0x4]),
        ...
        (0x458 => _reserved36: [ReadWrite<u8>; 0x8]),
        ...
        (0x468 => _reserved37: [ReadWrite<u8>; 0x8]),
        (0x470 => pub CLK_RST_CONTROLLER_CPU_CMPLX_STATUS_0: ReadOnly<u32>),
        (0x474 => _reserved38: [ReadWrite<u8>; 0x4]),
        ...
        (0x558 => _reserved41: [ReadWrite<u8>; 0x4]),
        ...
        (0x568 => _reserved42: [ReadWrite<u8>; 0x8]),
        ...
        (0x57C => _reserved43: [ReadWrite<u8>; 0x14]),
        ...
        (0x5AC => _reserved44: [ReadWrite<u8>; 0x18]),
        ...
        (0x5DC => _reserved45: [ReadWrite<u8>; 0x8]),
        ...
        (0x5F8 => _reserved46: [ReadWrite<u8>; 0x8]),
        ...
        (0x634 => _reserved47: [ReadWrite<u8>; 0xC]),
        ...
        (0x648 => _reserved48: [ReadWrite<u8>; 0x4]),
        ...
        (0x654 => _reserved49: [ReadWrite<u8>; 0x4]),
        ...
        (0x684 => _reserved52: [ReadWrite<u8>; 0x8]),
